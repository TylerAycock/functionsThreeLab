...
const totalPop = populations.reduce((acc, curr) =>{
 return acc + curr})
...
// const totals = orders.map(num => num.price * (1 + num.tax)) //this is the arrow function method 
...
let onlyBob = purchases.filter(function(name) {
